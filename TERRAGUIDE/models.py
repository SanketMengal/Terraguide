...
class Gardner(models.Model):
    ...
    def set_password(self, password):
        """
        Set the password for this Gardner, hashing it first.
        """
        self.password = make_password(password)
    def check_password(self, password):
        """
        Check the given password against the stored hash for this Gardner.
        """
   ...
   # experience = models.CharField(max_length=100)
    ...
    #certificate = models.FileField(upload_to='Gardner_certificates', blank=True)
...
class pending_Gardners(models.Model):
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=100)
    email = models.EmailField(default="")
